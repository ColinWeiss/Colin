namespace Colin.Core.Common
{
  ...
  public interface IRenderableISceneModule : IDisposable
  {
    ...
    void OnClientSizeChanged(object o, EventArgs e)
    {
      InitRenderTarget();
    }
  }
