...
using Colin.Common.Code.Physics.Tools.PolygonManipulation;
using Colin.Common.Code.Physics.Tools.Triangulation.TriangulationBase;
using Microsoft.Xna.Framework;

namespace Colin.Common.Code.Physics.Tools.TextureTools
{
