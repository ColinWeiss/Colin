...
using Colin.Common.Code.Physics.Tools.Triangulation.Delaunay.Delaunay;
using Colin.Common.Code.Physics.Tools.Triangulation.Delaunay.Delaunay.Sweep;
using Microsoft.Xna.Framework;
using System.Diagnostics;

namespace Colin.Common.Code.Physics.Tools.Triangulation.Delaunay
{
    /// <summary>
