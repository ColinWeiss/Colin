...
using Colin.Common.Code.Physics.Tools.ConvexHull.GiftWrap;
using Colin.Common.Code.Physics.Tools.Triangulation.Bayazit;
using Colin.Common.Code.Physics.Tools.Triangulation.Delaunay;
using Colin.Common.Code.Physics.Tools.Triangulation.Earclip;
using Colin.Common.Code.Physics.Tools.Triangulation.FlipCode;
using Colin.Common.Code.Physics.Tools.Triangulation.Seidel;
using System.Diagnostics;

namespace Colin.Common.Code.Physics.Tools.Triangulation.TriangulationBase
{
