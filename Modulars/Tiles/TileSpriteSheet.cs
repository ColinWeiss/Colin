...
namespace Colin.Core.Modulars.Tiles
{
    /// <summary>
    /// 物块纹理版式
    /// 记录一组 物块+边框+转角 在纹理中的位置 以及每组的高度
    /// 如果纹理图像的高度是多组的高度，则随机从中取出一组作为物块帧
    /// </summary>
    public class TileSpriteSheet
    {
        ...
        {
            if (!inited) LoadTileSpriteSheets();
        ...
        public static void LoadTileSpriteSheets()
        {
            ...
            RegisterTileSpriteSheet("SpecialBlock", new Point(112, 16), new Point(64, 16), new Point(16, 16), 48);
            inited = true;
        }
